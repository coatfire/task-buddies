  ...
  return (
    <div className="h-full min-h-0 flex flex-col px-1 py-1 text-ink overflow-hidden sm:py-2">
      ...
      <div className="text-center mb-3 px-2 shrink-0 sm:mb-6 sm:px-4">
        ...
        <p className="hidden max-w-[18rem] mx-auto text-ink-muted text-[13px] font-body leading-snug sm:block sm:max-w-none sm:text-sm sm:leading-normal">Tap the arrows to find your buddy for today.</p>
      </div>
              ...
              {characters.map((char) => (
                <div key={char.id} className="flex h-full flex-[0_0_100%] min-w-0 px-1">
                  ...
                  >
                    ...
                    <div className="relative mb-3 flex w-full flex-1 items-center justify-center rounded-[20px] bg-[#FAF3E8] border border-border-card overflow-visible min-h-[min(13.5rem,30dvh)] sm:mb-4 sm:min-h-0">
      ...
      <div className="max-w-sm mx-auto rounded-[24px] border border-border-card bg-surface px-3 py-2 shadow-soft text-center shrink-0 sm:px-4 sm:py-3">
        <p className="text-ink-muted text-[12px] font-body leading-snug sm:text-sm sm:leading-relaxed">Each buddy brings a slightly different energy. Pick the one that feels right today.</p>
